...
The interactive geospatial maps generated by this pipeline are hosted live and fully functional via Vercel. You can experience the dynamic point-cluster and heatmap features directly in your browser using the public links below:

🔗 **[Click Here to Open the Interactive Point-Cluster Map](https://bristol-crime-map.vercel.app/bristol_crime_map.html)**

🔗 **[Click Here to Open the Live Dynamic Crime Heatmap](https://bristol-crime-map.vercel.app/bristol_crime_heatmap.html)**
